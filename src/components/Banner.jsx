...
const Banner = () => {
  return (
    <div className="flex gap-2 items-center bg-gray-200 p-4 px-32 mx-auto">
      <div className="flex-shrink-0 mr-4">
        <img src="https://i.ibb.co/rQcbmqs/christmas-toys-background-flat-design-23-2148350472.jpg" alt="Banner Image" className="ml-6" />
      </div>
      <div>
        <h2 className="text-2xl font-bold">Welcome to Our Website</h2>
        <p className="mt-2 w-[550px]">
